...
namespace SportPlanner.Infrastructure.Migrations
{
    ...
    [Migration("20251101154839_20251101_UpdateObjectivesPlanning")]
    partial class _20251101_UpdateObjectivesPlanning
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SportPlanner.Domain.Entities.Planning.CalendarEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("TrainingPlanId")
                        .HasDatabaseName("ix_calendar_events_training_plan_id");

                    b.HasIndex("WorkoutId")
                        .HasDatabaseName("ix_calendar_events_workout_id");
            ...
            modelBuilder.Entity("SportPlanner.Domain.Entities.Planning.Itinerary", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("SportPlanner.Domain.Entities.Planning.ItineraryMarketplaceItem", b =>
                {
                    ...
                    b.HasKey("ItineraryId", "MarketplaceItemId")
                        .HasName("pk_itinerary_marketplace_items");

                    b.HasIndex("MarketplaceItemId")
                        .HasDatabaseName("ix_itinerary_marketplace_items_marketplace_item_id");

                    b.ToTable("itinerary_marketplace_items", (string)null);
                });
            ...
            modelBuilder.Entity("SportPlanner.Domain.Entities.Team", b =>
                {
                    ...
                    b.Property<Guid?>("CoachSubscriptionUserId")
                        .HasColumnType("uuid")
                        .HasColumnName("coach_subscription_user_id");
                    ...
                    b.HasIndex("CoachSubscriptionUserId")
                        .HasDatabaseName("ix_teams_coach_subscription_user_id");
            ...
            modelBuilder.Entity("SportPlanner.Domain.Entities.Planning.CalendarEvent", b =>
                {
                    b.HasOne("SportPlanner.Domain.Entities.Planning.TrainingPlan", "TrainingPlan")
                        ...
                        .HasConstraintName("fk_calendar_events_training_plans_training_plan_id");
                    ...
                    b.HasOne("SportPlanner.Domain.Entities.Planning.Workout", "Workout")
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_calendar_events_workouts_workout_id");
            ...
            modelBuilder.Entity("SportPlanner.Domain.Entities.Planning.ItineraryMarketplaceItem", b =>
                {
                    b.HasOne("SportPlanner.Domain.Entities.Planning.Itinerary", "Itinerary")
                        .WithMany("Items")
                        .HasForeignKey("ItineraryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_itinerary_marketplace_items_itineraries_itinerary_id");
                    ...
                    b.HasOne("SportPlanner.Domain.Entities.Planning.MarketplaceItem", "MarketplaceItem")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_itinerary_marketplace_items_marketplace_items_marketplace_i");
            ...
            modelBuilder.Entity("SportPlanner.Domain.Entities.Team", b =>
                {
                    ...
                    b.HasOne("SportPlanner.Domain.Entities.SubscriptionUser", "Coach")
                        .WithMany()
                        .HasForeignKey("CoachSubscriptionUserId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_teams_subscription_users_coach_subscription_user_id");
